...
<head>
    ...
    <title>CollectWorld - Harry Potter > Castelo de Hogwarts </title>
...
<body>
    ...
    <div class="item_painel">
        <div class="item_titulo">
            <h1>Castelo de Hogwarts</h1>
        </div>
        <div class="conteudo_item">
            <div class="item_castelo_img">
                <img src="./imagens/castelo.jpg" alt="Castelo de Hogwarts">
            </div>
            <div class="descricao_item">
                ...
                <ul>
                    ...
                    <li>
                        <h2>Descrição:</h2>
                        <p>O Castelo de Hogwarts com 6020 peças - Explore a complexa arquitetura das câmaras, torres e
                            salas de aula do castelo, bem como as suas características e cenários dos filmes de Harry
                            Potter.
                            Adicione 27 microfiguras, incluindo Harry, Hermione e Ron, junto de uma variedade de
                            acessórios e artefactos icónicos. Termine a sua experiência mágica de construção com a
                            adição da cabana de Hagrid e a Árvore do Salgueiro Lutador.
                        </p>
                    </li>
                    <li>
                        <h2>Preço:</h2>
