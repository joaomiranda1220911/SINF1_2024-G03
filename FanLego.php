...
<head>
    ...
    <title>CollectWorld - Harry Potter > FanLego </title>
...
<body>
    ...
    <div class="item_painel">
        ...
        <div class="conteudo_item">
            <div class="FanLego_img">
                <img src="./imagens/FanLego_sinf1.jpg" alt="FanLego">
            </div>
            <div class="descricao_item">
                ...
                <ul>
                    ...
                    <li>
                        <h2>Descrição:</h2>
                        <p>Visite o ensolarado Portugal e experimentar este evento LEGO Fan único. Faremos mais uma vez
                            a acolhedora aldeia de Paredes de Coura no centro da comunidade AFOL.
                            Organizados pela Comunidade 0937, esperamos reunir fãs de LEGO® de todo o mundo e tornar
