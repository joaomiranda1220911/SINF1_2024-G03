...
<head>
    ...
    <title>CollectWorld - Harry Potter > Lugola </title>
...
<body>
    ...
    <div class="item_painel">
        <div class="item_titulo">
            <h1>LUGOLA BrickFest </h1>
        </div>
        <div class="conteudo_item">
            <div class="Lugola_img">
                <img src="./imagens/Lugola_sinf1.jpg" alt="LUGOLA  BrickFest">
            </div>
                ...
                <ul>
                    ...
                    <li>
                        ...
                        <p>Junte-se à LUGOLA no BrickFest Live Pasadena.
                            Estaremos exibindo nossas criações próprias (MOCs) e compartilhando nosso amor pela LEGO com
                            o público.
                        </p>
                    </li>
                    ...
                    <li>
                        <h2>Data:</h2>
                        <p>12 JULHO 2024 - 14 JULHO 2024</p>
                    </li>
