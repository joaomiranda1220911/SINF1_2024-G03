...
<head>
    ...
    <title>CollectWorld - Harry Potter > OeirasBrink </title>
...
<body>
    ...
    <div class="item_painel">
        <div class="item_titulo">
            <h1>Brink em Oeiras </h1>
        </div>
        <div class="conteudo_item">
            <div class="oeiras_brink_img">
                <img src="./imagens/Oeiras_brink_sinf1.jpg" alt="Brink em Oeiras">
            </div>
            <div class="descricao_item">
                ...
                <ul>
                    ...
                    <li>
                        <h2>Descrição:</h2>
                        <p>O maior evento da PLUG regressa a Oeiras!
                            Este será o evento de fãs de LEGO mais ecológico deste ano. Mais de 6 milhões de pessas em
                            exposição.
                        </p>
                    </li>
                    ...
                    <li>
                        <h2>Data:</h2>
                        <p>25 ABRIL 2024 - 28 ABRIL 2024</p>
                    </li>
